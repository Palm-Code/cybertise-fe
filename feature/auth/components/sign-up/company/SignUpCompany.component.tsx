...
import HackerStepOne from "./form/CompanyStepOne.form";
import HackerStepTwo from "./form/CompanyStepTwo.form";
...
const SignUpCompany = () => {
  ...
  const { step, next, back, isFirstStep, currentStepIndex, steps } =
    useMultistepForm([
      {
