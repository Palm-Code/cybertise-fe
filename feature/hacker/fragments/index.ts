export { default as DashboardFragment } from "./dashboard/Dashboard.fragment";
export { default as ProgramDetailsFragment } from "./programs/details/ProgramDetails.fragment";
