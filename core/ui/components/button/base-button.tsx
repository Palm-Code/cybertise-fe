  ...
  "inline-flex cursor-pointer items-center justify-center whitespace-nowrap transition-colors gap-2.5 disabled:cursor-not-allowed disabled:text-neutral-light-50 disabled:dark:text-neutral-dark-50",
  {
    variants: {
      variant: {
        ...
        "secondary-hacker":
          "border bg-transparent text-brand-neutral dark:text-white hover:bg-lime-lighter-light/20 dark:hover:bg-lime-lighter-dark/20 focus:bg-lime-lighter-light/20 dark:focus:bg-lime-lighter-dark/20 active:bg-lime-lighter-light dark:active:bg-lime-lighter-dark border-lime-normal-light dark:border-lime-normal-dark hover:border-lime-normal-light dark:hover:border-lime-normal-dark active:border-lime-lighter-light/20 active:!text-brand-neutral dark:active:border-lime-lighter-dark/20 disabled:bg-transparent disabled:border-brand-neutral disabled:dark:border-white",
        "tertiary-hacker":
